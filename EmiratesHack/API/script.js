...
function getFlightAvailability(date, origin_city, destination_city){
  ...
  var url = `https://ec2-54-77-6-21.eu-west-1.compute.amazonaws.com:8143/${api}/1.0/?${flight_date}&${origin}&${destination}&${flight_class}`;
